...
// if a country has one timezone, use it is an alias
module.exports = {
  "Europe/Andorra": {
    "countryCode": "AD",
    "country": "Andorra"
  ...
  "America/Monterrey": {
    "desc": [
      "Central Time - Durango","Coahuila, Nuevo León, Tamaulipas"
    ]
  },
  "America/Matamoros": {
    "desc": [
  ...
  "America/Boise": {
    "desc": [
      "Mountain - ID (south)","Mountain - ID (east)"
    ]
  },
  "America/Phoenix": {
    "desc": [
