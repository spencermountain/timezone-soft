module.exports = {
  ...
  Africa_Southern: ['Africa/Johannesburg', 'Africa/Maseru', 'Africa/Mbabane'],
  Hawaii_Aleutian: ['America/Adak', 'Pacific/Honolulu', 'Pacific/Johnston'],
  Alaska: [
    'America/Anchorage',
    'America/Juneau',
    'America/Metlakatla',
  ...
  Mexico_Pacific: ['America/Chihuahua', 'America/Hermosillo', 'America/Mazatlan'],
  ...
  Peru: ['America/Lima'],
  America_Pacific: ['America/Los_Angeles', 'America/Tijuana', 'America/Vancouver', 'PST8PDT'],
  ...
  Mongolia: ['Asia/Choibalsan', 'Asia/Ulaanbaatar'],
  ...
  Australia_Central: ['Australia/Adelaide', 'Australia/Broken_Hill', 'Australia/Darwin'],
