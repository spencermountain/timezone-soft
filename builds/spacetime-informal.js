(function (global, factory) {
  ...
  Object.keys(iana).forEach(function (k) {
    iana[k].forEach(function (str) {
      ...
      var _final = titlecase(k) + '/' + titlecase(str);

      zones[str] = _final;
      zones[lowerCase] = _final;
    });
  });
  var _01Iana = zones;
  ...
  var _04OldZones = {
    ...
    mst: 'etc/gmt+7',
    hst: 'etc/gmt+10',
    'asia/ho_chi_minh': 'asia/saigon' // cet: 'europe/paris',
  ...
  var _05Metazones = [//this one needs work
  {
    standard: {
    ...
    pick: 'europe/london',
    zones: ['africa/abidjan', 'africa/accra', 'africa/bamako', 'africa/banjul', 'africa/bissau', 'africa/conakry', 'africa/dakar', 'africa/freetown', 'africa/lome', 'africa/monrovia', 'africa/nouakchott', 'africa/ouagadougou', 'africa/sao_tome', 'america/danmarkshavn', 'antarctica/troll', 'atlantic/reykjavik', 'atlantic/st_helena', 'etc/gmt', 'europe/dublin', //?
  ...
  //middle-east
  {
    ...
    standard: {
      name: 'south east asia standard time',
      abbrev: 'ict'
    },
    alias: ['indochina'],
    pick: 'asia/bangkok',
    ...
    pick: 'asia/shanghai',
    zones: ['asia/macau', 'asia/shanghai'] // kazakhstan_eastern: ['asia/almaty', 'asia/qostanay'],
    // anadyr: ['asia/anadyr'],
  ...
  var find = function find(str) {
    ...
    var tmp = str.replace(/( standard| daylight)? time$/, '');
