(function (global, factory) {
  ...
  var lexicon = efrtUnpack_min(_data); // console.log(Object.keys(lexicon).filter((k) => typeof lexicon[k] !== 'string'))
