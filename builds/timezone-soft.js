(function (global, factory) {
  ...
  }, //North america
  {
    ...
    am + 'Chihuahua', am + 'Hermosillo', am + 'Mazatlan']
  }, {
    std: {
    ...
    pick: am + 'New_York',
    ids: [am + 'Cancun', am + 'Cayman', am + 'Coral_Harbour', am + 'Detroit', am + 'Grand_Turk', am + 'Indiana', am + 'Indianapolis', am + 'Iqaluit', am + 'Jamaica', am + 'Kentucky', am + 'Louisville', am + 'Nassau', am + 'New_York', am + 'Nipigon', am + 'Panama', am + 'Pangnirtung', am + 'Port-au-prince', am + 'Thunder_Bay', am + 'Toronto', am + 'Montreal']
  }, {
    std: {
  ...
  }, //South america
  {
    ...
    pick: am + 'Sao_Paulo',
    ids: [am + 'Araguaina', am + 'Bahia', am + 'Belem', am + 'Fortaleza', am + 'Maceio', am + 'Recife', am + 'Santarem', am + 'Sao_Paulo']
  }, {
    std: {
      name: 'Argentina Time',
      abbrev: 'ART'
