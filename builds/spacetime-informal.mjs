...
console.log(Object.keys(lexicon).filter(function (k) {
  return typeof lexicon[k] !== 'string';
}));
console.log(lexicon.canberra); //try to match these against iana form
