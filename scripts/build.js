...
var banner =
  '/* spacetime v' + pkg.version + '\n   github.com/spencermountain/timezone-soft\n   MIT\n*/\n'
var uncompressed = './builds/timezone-soft.js'
var compressed = './builds/timezone-soft.min.js'
...
var cmd = browserify + ' ./src/index.js --standalone timezone-soft'
